      ...
      <div className="relative z-20 h-screen min-h-[720px] flex items-center">
        <div className="max-w-7xl mx-auto px-8 w-full">
          ...
          <div className="max-w-2xl text-start">
            ...
            {/* Heading */}
            <h1 className="font-hero font-semibold leading-[1.02] tracking-[-0.02em] text-[clamp(34px,5.5vw,64px)] text-white animate-fade-up animate-delay-1">
              {t("hero.title_line1")} <br />

              <span className="relative inline-block">

                {/* ALT gradient: navy → gold */}
