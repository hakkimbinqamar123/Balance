      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {icons.map((icon, i) => (
            <div
              key={i}
              className="group bg-[#202C53]/85 border border-[#202C53] rounded-2xl p-8 hover:border-[#EAC868] hover:-translate-y-2 transition duration-300 shadow-xl text-start"
            >
